...
@Entity
@Table(name = "jobadmission", schema = "public")
public class JobAdmissionBE {
	...
	public JobAdmissionBE() {
		
	}
	
	public JobAdmissionBE(
			 String department, String jobname, ArrayList<String> focalpoints, int salary, String location,
			String departmentinformation, String jobinformation, String customerphone,
			String customermail, final Status status, 
	...
	public JobAdmissionBE(
			final Long id, String department, String jobname, ArrayList<String> focalpoints, int salary, String location,
			String departmentinformation, String jobinformation, String customerphone,
			String customermail, final Status status, 
			final LocalDateTime created, final LocalDateTime modified
			) {
